...
export default function CaseStudy() {
    return (
        <section id="casestudy" className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center gap-8 font-instrument mb-20">
            ...
            <div className="columns-1 md:columns-2 xl:columns-3 gap-6 space-y-6 px-4 py-4">
